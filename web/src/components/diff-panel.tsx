  ...
  return (
    <section className="rounded-[24px] border border-stone-200 bg-white p-4">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          <div className="text-xs font-semibold uppercase tracking-[0.22em] text-stone-500">Code Diff</div>
          <h4 className="mt-2 text-2xl font-semibold tracking-[-0.04em] text-stone-950">repo 级 patch 回看</h4>
        </div>
        <div className="text-xs text-stone-500">当前先展示 unified diff</div>
      </div>

      {reposWithDiff.length === 0 ? (
        <div className="rounded-[18px] border border-dashed border-stone-300 bg-stone-50 px-4 py-6 text-sm leading-6 text-stone-500">
          ...
          {activeRepo?.diffSummary ? (
            <div className="space-y-4">
              ...
              <div className="rounded-[18px] border border-stone-200 bg-white px-3 py-3">
                <div className="mb-2 text-[11px] uppercase tracking-[0.2em] text-stone-500">Files In Diff</div>
