    ...
    <div className="space-y-4">
      <section className="rounded-[26px] border border-stone-200 bg-stone-50/70 p-5 dark:border-white/10 dark:bg-white/5">
        <div className="max-w-4xl">
          <div className="text-xs font-semibold uppercase tracking-[0.22em] text-stone-500 dark:text-stone-400">Workspace</div>
          <h2 className="mt-2 text-[32px] font-semibold tracking-[-0.05em] text-stone-950 dark:text-stone-50">隔离执行与路径关系</h2>
      ...
      <div className="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        <section className="rounded-[24px] border border-stone-200 bg-white p-4 dark:border-white/10 dark:bg-white/6">
          <div className="mb-4 text-xs font-semibold uppercase tracking-[0.22em] text-stone-500 dark:text-stone-400">Paths</div>
      ...
      <section className="rounded-[24px] border border-stone-200 bg-white p-4 dark:border-white/10 dark:bg-white/6">
        <div className="mb-4 text-xs font-semibold uppercase tracking-[0.22em] text-stone-500 dark:text-stone-400">Recent Worktrees</div>
        <div className="space-y-3">
          {tasks.map((task) => (
